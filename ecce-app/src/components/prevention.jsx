    ...
    return (
        <div className="flex flex-row items-center justify-around w-full h-half">
            ...
            <div className="info-box font-inter bg-ucla">
                <p className="collapse-text text-2xl">
